Shader "Hidden/Locked/.poiyomi/Poiyomi Toon URP/649aedb325715da4fba3d20d03fc2300"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, bool facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiFragData.baseColor *= poiThemeColor(poiMods, float4(0.1529262,0.04666508,0.03310476,1).rgb, 0.0);
				poiFragData.alpha = mainTexture.a * float4(0.1529262,0.04666508,0.03310476,1).a;
				#else
