Shader "Hidden/Locked/.poiyomi/Poiyomi Toon URP/4926e9e45105b8143a1a8ec40a4e68dc"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, bool facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiFragData.baseColor *= poiThemeColor(poiMods, float4(0.09530746,0.08021981,0.07036009,1).rgb, 0.0);
				poiFragData.alpha = mainTexture.a * float4(0.09530746,0.08021981,0.07036009,1).a;
				#else
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyOutlineColor(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiMods poiMods, in PoiCam poiCam)
			{
				...
				float4 outlineColor = float4(0.2411783,0.1905622,0.1714979,1);
				#ifdef POI_AUDIOLINK
