Shader "Hidden/Locked/.poiyomi/Poiyomi Toon URP/ac0fd55df59b3dd4e8565cd65d71aabf"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, bool facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiFragData.baseColor *= poiThemeColor(poiMods, float4(0.08650045,0.03433981,0.01850021,1).rgb, 0.0);
				poiFragData.alpha = mainTexture.a * float4(0.08650045,0.03433981,0.01850021,1).a;
				#else
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyOutlineColor(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiMods poiMods, in PoiCam poiCam)
			{
				...
				float4 outlineColor = float4(0.5366519,0.1081221,0.02616668,1);
				#ifdef POI_AUDIOLINK
