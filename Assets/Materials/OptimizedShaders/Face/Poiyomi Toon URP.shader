Shader "Hidden/Locked/.poiyomi/Poiyomi Toon URP/03f0f6203d9f6944ca49dd90ea1bf1b5"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, bool facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiFragData.baseColor *= poiThemeColor(poiMods, float4(0.799103,0.799103,0.799103,1).rgb, 0.0);
				poiFragData.alpha = mainTexture.a * float4(0.799103,0.799103,0.799103,1).a;
				#else
